          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="w-full mb-16">
              <div className="max-w-2xl mx-auto">
                <HeroSlideshow images={dropNGrowContent.heroImages} aspectRatio="aspect-[4/3]" />
              </div>
            </div>
          </div>
        </div>
